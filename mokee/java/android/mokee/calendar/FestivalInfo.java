...
public class FestivalInfo {
    ...
    public static String [] getFestivalInfo() {
        ...
        if (locale.getCountry().equals("CN")) {
            festivalInfo = new String [] { "0101 元旦", "0214 情人节", "0308 妇女节", "0312 植树节",
            ...
            festivalInfo = new String [] { "0101 元旦", "0214 情人節", "0308 婦女節", "0401 愚人節",
            ...
            festivalInfo = new String [] { "0101 元旦", "0214 情人節", "0228 和平紀念", "0308 婦女節",
