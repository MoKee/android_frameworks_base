...
public class SolarTerm {
    ...
    private static int[] solarTermArray = new int[] {
    ...
    public static String getSolarTermInfo(int year, int month, int day) {
        String[] array = Resources.getSystem().getStringArray(
                com.android.internal.R.array.solar_term);
        return ChineseCalendarUtils.getSolarTermInfoFromArray(year, month, day, array,
                solarTermArray);
    }
}
