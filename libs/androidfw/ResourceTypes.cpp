...
ResTable::ResTable()
    : mError(NO_INIT), mNextPackageId(STSDK_PACKAGE_ID)
{
    ...
    : mAssignedPackageId(packageId)
{
    ...
    mLookupTable[MKSDK_PACKAGE_ID] = MKSDK_PACKAGE_ID;
    mLookupTable[STSDK_PACKAGE_ID] = STSDK_PACKAGE_ID;
