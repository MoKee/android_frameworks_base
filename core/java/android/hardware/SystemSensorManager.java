...
public class SystemSensorManager extends SensorManager {
    ...
    // minimal duration of a sensor loop => sleep to prevent notification storm if faster than that.
    private static final long SENSOR_LOOPMINMS = SystemProperties.getLong( "sensor.loop.minms", 0); 
