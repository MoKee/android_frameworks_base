...
public class Camera {
    ...
    private PictureCallback mOPServiceJpegCallback;
    ...
    private void getNativeCameraMetadata(int camID) {
        try {
            ...
            CameraManager manager = (CameraManager) am.getApplication()
    ...
    private class EventHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            case CAMERA_MSG_AEC:
                if (mAECallback != null) {
                    int [] states = new int[] {msg.arg1, msg.arg2};
    ...
    public final void takePicture(ShutterCallback shutter, PictureCallback raw,
        ...
        if (mOneplusCallback != null) {
            ...
            try {
                Field ptrField = CameraMetadataNative.class
