...
#****************************************************************************************
# Run this script to move your MK50 device move back to a MK44 state. This is
# useful when you want to manually test MK44 to MK50 upgrade without reflashing the device
#***************************************************************************************
