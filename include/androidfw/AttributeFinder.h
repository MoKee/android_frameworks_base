...
private:
    ...
    Iterator mMKFrameworkStart;
    Iterator mSmartisanFrameworkStart;
    Iterator mAppStart;
...
void BackTrackingAttributeFinder<Derived, Iterator>::jumpToClosestAttribute(const uint32_t packageId) {
    switch (packageId) {
        case 0x01:
            ...
            break;
        case 0x0b:
            mCurrent = mSmartisanFrameworkStart;
            break;
        case 0x3f:
            mCurrent = mMKFrameworkStart;
            break;
        case 0x7f:
            mCurrent = mAppStart;
            break;
...
void BackTrackingAttributeFinder<Derived, Iterator>::markCurrentPackageId(const uint32_t packageId) {
    switch (packageId) {
        case 0x01:
            ...
            break;
        case 0x0b:
            mSmartisanFrameworkStart = mCurrent;
            break;
        case 0x3f:
            mMKFrameworkStart = mCurrent;
            break;
        case 0x7f:
            mAppStart = mCurrent;
            break;
