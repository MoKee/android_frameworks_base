...
public class CpuCoreToggle extends PowerSaverToggle {

    private static final String TAG = "PowerSaverService_CpuCoreToggle";

    public CpuCoreToggle(Context context) {
        super(context);
    }

    protected boolean isEnabled() {
        return Settings.System.getInt(mContext.getContentResolver(), Settings.System.POWER_SAVER_CPU_CORE, 0) != 0;
    }
