...
public class StatusBarNetworkTraffic extends NetworkTraffic {
    ...
    public StatusBarNetworkTraffic(final Context context) {
        this(context, null);
    }

    public StatusBarNetworkTraffic(final Context context, final AttributeSet attrs) {
    ...
    public StatusBarNetworkTraffic(final Context context, final AttributeSet attrs,
        ...
        BarBackgroundUpdater.addListener(new BarBackgroundUpdater.UpdateListener(this) {
            ...
            public ObjectAnimator onUpdateStatusBarIconColor(final int previousIconColor,
                ...
                return ObjectAnimator.ofObject(StatusBarNetworkTraffic.this, "textColor",
