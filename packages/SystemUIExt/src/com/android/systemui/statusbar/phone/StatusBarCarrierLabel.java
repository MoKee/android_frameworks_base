...
public class StatusBarCarrierLabel extends CarrierLabel {
    private final int mDSBDuration;

    public StatusBarCarrierLabel(final Context context) {
        this(context, null);
    }

    public StatusBarCarrierLabel(final Context context, final AttributeSet attrs) {
    ...
    public StatusBarCarrierLabel(final Context context, final AttributeSet attrs,
        ...
        BarBackgroundUpdater.addListener(new BarBackgroundUpdater.UpdateListener(this) {
            ...
            public ObjectAnimator onUpdateStatusBarIconColor(final int previousIconColor,
                ...
                return ObjectAnimator.ofObject(StatusBarCarrierLabel.this, "textColor",
