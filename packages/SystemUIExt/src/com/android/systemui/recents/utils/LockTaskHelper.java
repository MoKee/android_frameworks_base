...
public class LockTaskHelper {
    ...
    private void refreshLockedTaskMap() {
        String taskMap = MKSettings.Secure.getString(mContext.getContentResolver(),
                MKSettings.Secure.LOCKED_RECENT_TASK_LIST);
    ...
    public void saveLockedTaskMap() {
        ...
        MKSettings.Secure.putString(mContext.getContentResolver(),
                MKSettings.Secure.LOCKED_RECENT_TASK_LIST, value);
    }
