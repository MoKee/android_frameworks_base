...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    private static final String POWER_MENU_ACTIONS_STRING =
            "mokeesecure:" + MoKeeSettings.Secure.POWER_MENU_ACTIONS;
    ...
    private final MoKeeGlobalActions mMoKeeGlobalActions;
    ...
    public GlobalActionsDialog(Context context, GlobalActionsManager windowManagerFuncs,
        ...
        mActions = mMoKeeGlobalActions.getUserActionsArray();
    }
