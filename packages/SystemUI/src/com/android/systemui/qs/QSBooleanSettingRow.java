    ...
    private void applyChange(boolean value) {
        ...
        switch (mWhichTable) {
            ...
            case TABLE_CM_GLOBAL:
                MKSettings.Global.putInt(cr, mKey, value ? 1 : 0);
                break;
            case TABLE_CM_SECURE:
                MKSettings.Secure.putInt(cr, mKey, value ? 1 : 0);
                break;
            case TABLE_CM_SYSTEM:
                MKSettings.System.putInt(cr, mKey, value ? 1 : 0);
                break;
        }
    }
    ...
    private boolean getCurrent() {
        ...
        switch (mWhichTable) {
            ...
            case TABLE_SYSTEM:
                ...
                break;
            case TABLE_CM_GLOBAL:
                ret = MKSettings.Global.getInt(cr, mKey, mDefaultValue);
                break;
            case TABLE_CM_SECURE:
                ret = MKSettings.Secure.getInt(cr, mKey, mDefaultValue);
                break;
            case TABLE_CM_SYSTEM:
                ret = MKSettings.System.getInt(cr, mKey, mDefaultValue);
                break;
        }
        return ret == 1;
    }
