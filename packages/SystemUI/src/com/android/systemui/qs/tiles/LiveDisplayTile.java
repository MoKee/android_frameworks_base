...
public class LiveDisplayTile extends QSTile<LiveDisplayTile.LiveDisplayState> {
    ...
    private static final Intent LIVEDISPLAY_SETTINGS =
            new Intent(MKSettings.ACTION_LIVEDISPLAY_SETTINGS);
    ...
    private void updateEntries() {
        Resources res = mContext.getResources();
        mEntries = res.getStringArray(org.mokee.platform.internal.R.array.live_display_entries);
        ...
        mValues = res.getStringArray(org.mokee.platform.internal.R.array.live_display_values);
    }
