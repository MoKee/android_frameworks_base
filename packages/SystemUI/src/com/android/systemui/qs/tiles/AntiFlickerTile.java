...
public class AntiFlickerTile extends QSTileImpl<BooleanState> {
    ...
    public AntiFlickerTile(QSHost host) {
        ...
        if (!updateConfig()) {
            mContext.registerReceiver(mReceiver,
                    new IntentFilter(mokee.content.Intent.ACTION_INITIALIZE_LIVEDISPLAY));
    ...
    private void setEnabled(boolean enabled) {
        MoKeeSettings.System.putInt(mContext.getContentResolver(),
                MoKeeSettings.System.DISPLAY_ANTI_FLICKER, enabled ? 1 : 0);
    }
    ...
    public int getMetricsCategory() {
        return MoKeeMetricsLogger.TILE_ANTI_FLICKER;
    }
