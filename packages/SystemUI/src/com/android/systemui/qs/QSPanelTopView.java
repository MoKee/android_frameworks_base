    ...
    class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(MKSettings.System.getUriFor(
                    MKSettings.System.QS_SHOW_BRIGHTNESS_SLIDER), false, this, UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            boolean showSlider = MKSettings.System.getIntForUser(resolver,
                    MKSettings.System.QS_SHOW_BRIGHTNESS_SLIDER, 1, currentUserId) == 1;
