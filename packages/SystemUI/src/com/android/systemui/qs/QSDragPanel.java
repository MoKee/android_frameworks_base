    ...
    class SettingsObserver extends UserContentObserver {
        ...
        protected void observe() {
            ...
            resolver.registerContentObserver(MKSettings.Secure.getUriFor(
                    MKSettings.Secure.QS_USE_MAIN_TILES), false, this, UserHandle.USER_ALL);
            update();
        }
        ...
        public void update() {
            ...
            boolean firstRowLarge = MKSettings.Secure.getIntForUser(resolver,
                    MKSettings.Secure.QS_USE_MAIN_TILES, 1, currentUserId) == 1;
