    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(MKSettings.Secure.getUriFor(
                    MKSettings.Secure.LOCK_SCREEN_WEATHER_ENABLED), false, this);
            update();
        }
        ...
        public void update() {
            ...
            mKeyguardWeatherEnabled = MKSettings.Secure.getInt(
                    resolver, MKSettings.Secure.LOCK_SCREEN_WEATHER_ENABLED, 0) == 1;
