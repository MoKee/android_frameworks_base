...
<<<<<<< HEAD   (1cc6d5 Merge "SystemUI: tiles: Migrate to new screenshot method wit)
...
=======
    private void sendCameraStateIntent(String cameraState) {
        Intent intent = new Intent(mokee.content.Intent.ACTION_CAMERA_STATUS_CHANGED);
        intent.putExtra(mokee.content.Intent.EXTRA_CAMERA_STATE, cameraState);
        mContext.sendBroadcastAsUser(intent, UserHandle.SYSTEM);
>>>>>>> CHANGE (b5fe37 core: Add camera intents for camera state [1/2])
    }
}
