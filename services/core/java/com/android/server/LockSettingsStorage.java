...
class LockSettingsStorage {
    ...
    private static final String MK_LEGACY_LOCK_PATTERN_FILE = "mk_gesture.key";
    ...
    public CredentialHash readPatternHash(int userId) {
        ...
        stored = readFile(getMkLegacyLockPatternFilename(userId));
        if (stored != null && stored.length > 0) {
            return new CredentialHash(stored, CredentialHash.VERSION_LEGACY);
        }
    ...
    public boolean hasPattern(int userId) {
        return hasFile(getLockPatternFilename(userId)) ||
            ...
            hasFile(getMkLegacyLockPatternFilename(userId));
    }
    ...
    String getMkLegacyLockPatternFilename(int userId) {
        return getLockCredentialFilePathForUser(userId, MK_LEGACY_LOCK_PATTERN_FILE);
    }
