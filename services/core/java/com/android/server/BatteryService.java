...
public final class BatteryService extends SystemService {
    ...
    private static final String DASH_STATUS_PATH = "/sys/class/power_supply/battery/fastchg_status";
    ...
    private boolean isDashCharger() {
        try (BufferedReader br = new BufferedReader(new FileReader(DASH_STATUS_PATH))) {
